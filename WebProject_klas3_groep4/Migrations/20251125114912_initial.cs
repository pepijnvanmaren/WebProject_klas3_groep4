        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GebruikerDBId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Producten", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Producten_AspNetUsers_GebruikerDBId",
                        column: x => x.GebruikerDBId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Veilingen_AspNetUsers_GebruikerDBId",
                        column: x => x.GebruikerDBId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Producten_GebruikerDBId",
                table: "Producten",
                column: "GebruikerDBId");

            migrationBuilder.CreateIndex(
                name: "IX_Veilingen_GebruikerDBId",
                table: "Veilingen",
                column: "GebruikerDBId");
        }
